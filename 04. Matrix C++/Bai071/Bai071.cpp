...
int DemCucTri(float[][100], int, int);
...
int main()
{
	...
	cout << "So luong cac gia tri cuc tri trong ma tran: " << DemCucTri(b, k, l);
	return 1;
}
...
int DemCucTri(float a[][100], int m, int n)
{
	int dem1 = DemCucTieu(a, m, n);
	int dem2 = DemCucDai(a, m, n);
	return (dem1 + dem2);
}