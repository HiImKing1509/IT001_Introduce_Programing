...
int DemDiemGocPhanTuThuIII(DIEM[][100], int, int);
...
int main()
{
	...
	cout << "\n--> So luong diem thuoc goc phan tu thu III trong ma tran: " << DemDiemGocPhanTuThuIII(b, k, l);
...
int DemDiemGocPhanTuThuIII(DIEM a[][100], int m, int n)
{
	int dem = 0;
	for (int i = 0; i < m; i++)
		for (int j = 0; j < n; j++)
